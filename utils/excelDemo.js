...
test ('Upload download excel validation',async ({page})=>{
        ...
        writeExcelTest("Iphone", "Apple", "C:/Users/Pankaj/Downloads/download.xlsx"); // calling that function----> just by enter the parameters value  ("text we search","text we replace","file path of that file")
